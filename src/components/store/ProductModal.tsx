            ...
            <div className="p-4 sm:p-6 flex flex-col gap-5">
                          ...
                          >
                            <div
                              ...
                              dangerouslySetInnerHTML={{
                                __html: stripColorStyles(product.description),
                              }}
                            />
                          </motion.div>
                        )}
                        ...
                        {isOpen && (
                          ...
                          >
                            <div
                              ...
                              style={{ lineHeight: "1.7" }}
                              dangerouslySetInnerHTML={{
                                __html: stripColorStyles(section.bodyHtml),
                              }}
                            />
                          </motion.div>
                        )}
              ...
              <div className="mt-auto flex flex-col gap-3 pt-2">
                ...
                <a
                  ...
                  className="w-full flex items-center justify-center gap-3 py-3 font-pixel text-base tracking-wider transition-all"
                  style={{
