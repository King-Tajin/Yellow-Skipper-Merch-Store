...
import { AlertTriangle, ChevronDown, ExternalLink, Ruler, X } from "lucide-react";
import { useState } from "react";
import { stripColorStyles } from "@/libs/productUtils";
                      ...
                      {linkUrl ? (
                        <>
                          <a
                            ...
                            className="flex items-center gap-2.5 px-4 py-3 font-pixel text-xs tracking-wider transition-all"
                            style={{
                              background:
                                "linear-gradient(180deg, #5000aa 0%, #28007c 100%)",
                          ...
                          <div className="flex items-start gap-2 px-3 py-2.5 bg-crown-gold/10 pixel-border-sm">
                            ...
                            <p className="font-code text-xs text-crown-amber leading-relaxed">
                              This product has an official size chart, please
                              use it for the most accurate fit. The general
                              reference below is backup only.
                            </p>
                          </div>
                        </>
                      ) : (
                        <div
                          ...
                          dangerouslySetInnerHTML={{
                            __html: stripColorStyles(sizeInfo.bodyHtml),
                          }}
                        />
                      )}
                    </div>
                        ...
                        <div className="pt-3 flex flex-col gap-3">
                          <div className="overflow-x-auto">
                            <table className="w-full font-code text-sm border-collapse">
                              <thead>
                                <tr
                                  style={{ background: "rgba(80,0,170,0.25)" }}
                                >
