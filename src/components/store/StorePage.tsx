...
export default function StorePage() {
  ...
  const [cartItems, setCartItems] = useState<CartItem[]>(() => {
    try {
      const saved = localStorage.getItem("ysg-merch-cart");
  ...
  useEffect(() => {
    try {
      localStorage.setItem("ysg-merch-cart", JSON.stringify(cartItems));
    } catch {}
  }, [cartItems]);
  ...
  return (
      <div className="min-h-screen bg-obsidian-900 block-pattern">
            ...
            {status === "error" && (
                ...
                >
                  ...
                  <button
                      ...
                      className="flex items-center gap-2 px-4 py-2 bg-crown-gold/10 border border-crown-gold/50 hover:border-crown-gold text-crown-gold font-pixel text-xs transition-all"
                  >
